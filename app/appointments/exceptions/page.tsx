...
export default async function Page() {
  ...
  return (
    <PageChrome
      ...
      subtitle="Exception queues for duplicate ids, stale pending bookings, approved deleted appointments, and Companion pricing-anomaly flags. Pricing anomalies are imported from cp_companion.anomalyFlags, the same derived signal source used by cp-companion platform APIs; this dashboard does not recompute them."
    >
      ...
      <SectionCard title="Pricing mismatches" description="Derived signal source: cp_companion.anomalyFlags. Treat this as a sync-pipeline output; stale flags must be regenerated by the Companion anomaly watchdog before they are trusted.">
