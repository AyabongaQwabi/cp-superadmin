...
import { findAppointmentsByEmployee } from "@/lib/ai-queries/appointments";
...
export async function GET(request: Request) {
  ...
  return NextResponse.json(await findAppointmentsByEmployee(employeeId, limit, appointmentFilters(params)));
}
